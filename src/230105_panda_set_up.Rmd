...
dir_path <- "~/CR/230321_JLF_Sex_bias_adverse_events/"
...
for( i in 1:length(tissues)){
  ...
  file_expression <- gsub(" ", "_", paste(
    dir_path, "results/ac_results/lioness/processed_normalized_expression/", 
    tissues[i], 
...
saveRDS(sinfo, here::here(
  "results", "ac_results", "230105_panda_setup_sInfo.RDS"))
```
