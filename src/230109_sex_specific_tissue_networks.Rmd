...
for (i in 1:length(tissues_wo_ws)){
  ...
  print(tissues[i])
  file_name<- paste(paste0(dir_path, "output/lioness/processed_normalized_expression/"), tissues_wo_ws[i], "_gtex_processed_expression.rds",sep = "")
  #print(file_name)
  ...
  file_male <- paste(paste0(dir_path, "output/alpaca/sex_specific_networks/"), tissues_wo_ws[i], "_M_panda.rds", sep = "")
  
  file_female <- paste(paste0(dir_path, "output/alpaca/sex_specific_networks/"), tissues_wo_ws[i], "_F_panda.rds", sep = "")
