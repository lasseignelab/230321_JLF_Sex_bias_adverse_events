...
dir_path <- "/home/clarkad/CR/230321_JLF_Sex_bias_adverse_events/"

# again I think a combination of your method with here 
# will be helpful for readability and adherence for 
# other scripts
data_path <- here::here(
  "data",
  "panda_input_data")
...
loaded via a namespace (and not attached):
 [1] compiler_4.2.2  here_1.0.1      magrittr_2.0.3  cli_3.6.1      
 [5] rprojroot_2.0.3 tools_4.2.2     glue_1.6.2      rstudioapi_0.14
 [9] vctrs_0.6.1     stringi_1.7.12  knitr_1.42      xfun_0.38      
[13] lifecycle_1.0.3 rlang_1.1.0
