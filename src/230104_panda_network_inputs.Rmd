...
```{r eval= FALSE}
download.file('https://stringdb-static.org/download/protein.links.v11.5/9606.protein.links.v11.5.txt.gz', destfile = "./data/panda_input_data/stringi_database_11_5_9606.txt.gz", method = "wget", extra= "--no-check-certificate")
```

```{r}
ppi_table<- read.delim("/data/project/lasseigne_lab/JLF_scratch/Sex_Bias_Adverse_Events/data/panda_input_data/stringi_database_11_5_9606.txt", sep= " ", header = TRUE)
```
...
```{r eval= FALSE}
download.file('https://stringdb-static.org/download/protein.info.v11.5/9606.protein.info.v11.5.txt.gz', destfile = "./data/panda_input_data/9606.protein.info.v11.5.txt.gz", method = "wget", extra= "--no-check-certificate")
```
...
```{r}
motif_info_table<- read.table("/data/project/lasseigne_lab/JLF_scratch/Sex_Bias_Adverse_Events/data/panda_input_data/Homo_sapiens_motifinfo.txt", sep= "\t", header = TRUE)
```
```{r}
...
```{r}
motif_table<- read.table("/data/project/lasseigne_lab/JLF_scratch/Sex_Bias_Adverse_Events/data/panda_input_data/hg38_refseq_-750_250_1e-4", sep= "\t")
```
...
```{r eval =FALSE}
saveRDS(symbol_motif_table, "/data/project/lasseigne_lab/JLF_scratch/Sex_Bias_Adverse_Events/data/panda_input_data/230104_symbol_motif_table.rds")
```
### Save Data
Done in script
