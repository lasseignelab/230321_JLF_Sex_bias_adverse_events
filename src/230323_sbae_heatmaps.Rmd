...
core_heatmap <- Heatmap(t(sbae_target_core_top), name = "Sex-bias Core Gene", col = colors, column_names_max_height = unit(4, "cm"), heatmap_legend_param = list(at = c("-1", "0","1e-15", "1"),labels= c("male", "not sex-bias","both", "female"), column_names_gp =gpar(fontsize = 18 , fontface = "bold"), row_names_gp =gpar(fontsize = 6 , fontface = "bold"), labels_gp = gpar(fontsize = 12, fontface = "bold") ))

draw( core_heatmap ,heatmap_legend_side="bottom")
dev.off()
```
