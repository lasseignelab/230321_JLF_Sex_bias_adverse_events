...
Heatmap(t(sbae_target_exp_top), name = "Sex-bias Gene Expression", 
        col = colors, 
...
core_heatmap <- Heatmap(t(sbae_target_core_top), name = "Sex-bias Core Gene", col = colors,
                        column_names_gp =gpar(fontsize = 11 , fontface = "bold"),
...
We investigated the top male (i.e., PPARA and PPARG) and top female (i.e., PGR , AR, NR3C1) bias genes based on the number of tissues as it a core gene in a sex-specific community.
