...
```{r}
panda_output_files <- list.files(paste0(dir_path, "/results/ac_results/alpaca/sex_specific_networks"))
```
...
```{r}
panda_adjusted_files <- list.files(paste0(dir_path, "/results/ac_results/alpaca/alpaca_adjusted_inputs"))
```
...
for (i in 1:length(panda_adjusted_files)){
  ...
  input<- readRDS(paste0(paste0(dir_path, "/results/ac_results/alpaca/alpaca_adjusted_inputs/"),  panda_adjusted_files[i], sep = ""))
...
<<<<<<< Updated upstream
  ...
  set.seed(101)
=======
  file_header <- paste0(paste0(dir_path, "/results/ac_results/alpaca/alpaca_run/"),  tissue_name, "_",sep = "")
...
<<<<<<< Updated upstream
  ...
  set.seed(101)
=======
  file_header <- paste0(paste0(dir_path, "/results/ac_results/alpaca/alpaca_run/"), tissue_name, "female", "male" , "_",sep = "")
